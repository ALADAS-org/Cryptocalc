...
contextBridge.exposeInMainWorld(
	"ipcMain", {
		...
		MnemonicsToHDWalletInfo:     (data) => ipcRenderer.invoke("request:mnemonics_to_hd_wallet_info", data),
		GetSimpleWallet:             (data) => ipcRenderer.invoke("request:get_simple_wallet", data),
		GetHDWallet:                 (data) => ipcRenderer.invoke("request:get_hd_wallet", data),
		//GetSimpleWalletFromMnemonics:(data) => ipcRenderer.invoke("request:get_simple_wallet_from_mnemonics", data),
        ...
        ShowOutputFolderInExplorer:  (data) => ipcRenderer.send("request:show_output_folder_in_explorer", data),		
