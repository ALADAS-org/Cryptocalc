    ...
    + 5.2. Use cases
        * 5.2.1. Generate a new _Wallet_ and import it in a _Wallet manager_  
		...
		a wallet generated by _CryptoCalc_:
            * 5.2.1.a. Choose _Wallet Mode_: _Simple Wallet_, _HD Wallet_ or _SWORD_		
            * 5.2.1.b. Choose a coin: `BTC`,`ETH`,`XRP`,`ADA`,`DOGE`,`LTC`,`SOL`,`AVX`,`TRON`,`BCH`,`DASH`,`Firo` 
		    * 5.2.1.c. Enter _Private Key_  (NB: or _WIF_ for `BTC` wallets)    
