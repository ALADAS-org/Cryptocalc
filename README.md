...
3. Release notes
	...
	+ 3.20. Features in `0.3.25`
	    * Added support of `XLM` (_Stellar_)
	+ 3.21. Features in `0.3.24`
...
4. _CryptoCalc_ User Guide  
    ...
    + 4.1. Features 
	    ...
	    * 4.1.3. _Entropy Source_ : `Image`, `Fortunes`, `D6 dices` and `Mouse moves`   
        ...
        and `Mouse moves` (entropy bytes are generated by the user when moving the mouse pointer) 		
