...
1. Purpose  
   ...
   NB: Since its first release _CryptoCalc_ has been downloaded 8384 times on `npm` (even though there is also bots involved 
   ...
   LTC (Litecoin), ETC (Ethereum Classic), VET (VeChain), ZEC (ZCASH), BSV (Bitcoin SV), DASH (Dash), RVN (Ravencoin),
