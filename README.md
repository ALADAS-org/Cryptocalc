...
4. _CryptoCalc_ User Guide  
    ...
    + 4.1. Features 
	    ...
	    * 4.1.3. _Entropy Source_ : `Image`, `Fortunes` or `D6 dices`    
		...
		and `D6 Dices` (number of rolls depends on _Entropy size_ e.g. 100 rolls for 256 bits). 
