...
1. Purpose  
   ...
   NB: Since its first release _CryptoCalc_ has been downloaded 8384 times on [npm](https://www.npmjs.com/) (even though there is also bots involved 
   ...
   DOGE (Dogecoin), TRX (TRON), ADA (Cardano), XLM (Stellar), BCH (Bitcoin Cash), AVAX (Avalanche), TON (Toncoin), 
   LTC (Litecoin), ETC (Ethereum Classic), VET (VeChain), BSV (Bitcoin SV), DASH (Dash), RVN (Ravencoin),
